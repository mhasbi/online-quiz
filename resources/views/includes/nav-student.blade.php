...
<nav class="red lighten-2" role="navigation">
  <div class="nav-wrapper container"><a id="logo-container" href="{{ url('/') }}" class="brand-logo">Online Quiz</a>
    <ul class="right hide-on-med-and-down">
      ...
      @if(Auth::user()->choosen_quiz == '0')
        <li><a href="{{url('/question-category')}}">Quiz List</a></li>
      @else
        <li><a href="{{url('/question-list/'.Auth::user()->choosen_quiz)}}">Quiz List</a></li>
      @endif
      <li><a href="{{url('/my-result')}}">My Result</a></li>
      <!-- Dropdown Trigger -->
